<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="appProyVentas.login" %>
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-with-news-feed">
			...
			<div class="right-content">
				...
				<!-- end login-header -->
				<asp:ObjectDataSource ID="odsServidores" runat="server" SelectMethod="PR_PAR_GET_DOMINIOS" TypeName="appProyVentas.Clases.Dominios">
					<SelectParameters>

...
namespace appProyVentas
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btnReset_Click(object sender, EventArgs e)
        {
            ...
            string resultado2 = objC.enviar(txtUsuario.Text, "Reseteo de contraseña del usuario " + txtUsuario.Text, "Estimado usuario :" + "<br/><br/> Su password temporal es el 123: <br/><br/>" + " <br/><br/> Ahora debe ingresar al sistema del siguiente link: <br/><br/>" + "https://200.105.209.42:5558" + "<br/><br/>Saludos coordiales.", "");
